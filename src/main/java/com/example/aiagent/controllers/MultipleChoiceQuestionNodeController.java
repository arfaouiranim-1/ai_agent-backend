...
import com.example.aiagent.services.MultipleChoiceQuestionNodeService;
...
@RestController
@RequestMapping("/api/graphs/{graphId}/nodes/multiple-choice")
public class MultipleChoiceQuestionNodeController {

    @Autowired private MultipleChoiceQuestionNodeService service;
