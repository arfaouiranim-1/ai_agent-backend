...
import com.example.aiagent.services.SingleChoiceQuestionNodeService;
...
@RestController
@RequestMapping("/api/graphs/{graphId}/nodes/single-choice")
public class SingleChoiceQuestionNodeController {

    @Autowired private SingleChoiceQuestionNodeService service;
